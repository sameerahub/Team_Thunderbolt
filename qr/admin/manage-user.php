            ...
            ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo SITEURL; ?>admin/update-u_password.php?id=<?php echo $user_id ?>" class="btn-primary">Change PassWord</a>
                                ...
                                <a href="<?php echo SITEURL; ?>admin/update-user.php?id=<?php echo $user_id ?>" class="btn-secondary">Update user</a>
                            </td>
                        </tr>
            <?php
